...
land_pairs[[4]] <- c(6, 8)
land_pairs[[5]] <- c(7, 10)
land_pairs[[6]] <- c(14, 15)
land_pairs[[7]] <- c(16, 17)
land_pairs[[8]] <- c(18, 21)
land_pairs[[9]] <- c(19, 22)
land_pairs[[10]] <- c(20, 23)
land_pairs[[11]] <- c(24, 25)
land_pairs[[12]] <- c(26, 30)
land_pairs[[13]] <- c(27, 31)
land_pairs[[14]] <- c(28, 32)
land_pairs[[15]] <- c(29, 33)
land_pairs[[16]] <- c(34, 35)
